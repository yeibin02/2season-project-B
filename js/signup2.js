window.addEventListener("load", function () {
    ...
    let timerInterval; // timerInterval을 전역 범위로 이동

    function validateInput(inputElement, containerElement, successClass, errorClass) {
...
function startTimer() {
  ...
  const timerInterval = setInterval(function () {
    ...
    completion.addEventListener('click', function (e) {
        ...
        clearInterval(timerInterval); // timerInterval을 clearInterval로 멈춤
    });
